...
import sty from "./PlasmicButton.module.css"; // plasmic-import: Adgj4buiGIlu/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___7Ijaz)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__zxWdE)}
                role={"img"}
              />
            ),
